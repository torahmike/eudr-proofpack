/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 70bc130a903a75bbbcbd05f42694d46f)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_compat
interface __BaseEnv_Env {
	PROOF_PACK_FILES: R2Bucket;
	DB: D1Database;
	ZIP_EXPORT_QUEUE: Queue;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production";
	APP_URL: "https://eudr-proofpack-staging.torahmike.workers.dev" | "https://eudr-proofpack.torahmike.workers.dev";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		APP_URL: "https://eudr-proofpack-staging.torahmike.workers.dev";
		SESSION_TTL_SECONDS: "604800";
		REQUIRE_VERIFIED_EMAIL: "false";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_URL" | "SESSION_TTL_SECONDS" | "REQUIRE_VERIFIED_EMAIL">> {}
}
